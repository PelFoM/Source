...
class PelvicFloor:
  def __init__(self, parent): 
    ...
    parent.dependencies = []
    parent.contributors = ["Ludek Hyncik (UWB)", "Magdalena Jansova (UWB)", "Adam Wittek (UWA)"]
    parent.helpText = """
...
class PelvicFloorWidget:
  ...
  def setup(self):
    ...
    ExpButton = qt.QPushButton("Export")
    ExpButton.toolTip = "Export model as unstructured VTK."
    ExpButton.connect('clicked(bool)', self.onExpButtonClicked)
    self.ExpButton = ExpButton
    pelvisFloorLayout.addWidget(ExpButton, row, column, rowHeight, colWidth)
    ...
    AlignButton.setStyleSheet('background-color: orange')
    ...
    CentreButton = qt.QPushButton("Centre")
    CentreButton.setStyleSheet('background-color: blue')
    CentreButton.toolTip = "Align model be centres of gravity of landmarks"
    CentreButton.connect('clicked(bool)', self.onCentreButtonClicked)
    self.CentreButton = CentreButton
    pelvisFloorLayout.addWidget(CentreButton, row, column, rowHeight, colWidth)

    column += colWidth # column position

    RigidButton = qt.QPushButton("Rigid")
    RigidButton.setStyleSheet('background-color: grey')
    RigidButton.toolTip = "Register model to target landmarks. " + \
      "At least four landmarks not lying on a plane must be present"
    RigidButton.connect('clicked(bool)', self.onRigidButtonClicked)
    self.RigidButton = RigidButton
    pelvisFloorLayout.addWidget(RigidButton, row, column, rowHeight, colWidth)
    ...
    BirthButton = qt.QPushButton("Curve of Carus")
    BirthButton.toolTip = "View birth canal based on landmarks identifed as Markups Nodes."
    BirthButton.connect('clicked(bool)', self.onBirthButtonClicked)
    self.BirthButton = BirthButton
    pelvisFloorLayout.addWidget(BirthButton, row, column, rowHeight, colWidth)
  ...
  def onExpButtonClicked(self): # export model
  ...
  def onCentreButtonClicked(self): # align centres of gravity of landmarks
    PelvicFloorLib.registrationButton('centre')

  def onRigidButtonClicked(self): # register model
    PelvicFloorLib.registrationButton('rigid')
  ...
  def onMorphButtonClicked(self): # morph model
    PelvicFloorLib.registrationButton('morphing')

  def onBirthButtonClicked(self): # birth canal view
    PelvicFloorLib.birthButton()
